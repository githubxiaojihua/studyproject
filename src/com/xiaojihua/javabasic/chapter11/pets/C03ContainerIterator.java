 ...
 * 3、iterator的用法
 */
public class C03ContainerIterator {
    ...
    public static void main(String[] args) throws InstantiationException, IllegalAccessException {
        ...
        LinkedList<C00Pet> petLl = new LinkedList<>(pets);
        HashSet<C00Pet> petHs = new HashSet<>(pets);
        ...
        TreeSet<C00Pet> petTs = new TreeSet<>(pets);
